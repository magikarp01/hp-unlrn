accelerate launch finetuning.py \
    --output_dir="verbatim_summary_finetune" \
    --train_file="verbatim_summary_train.jsonl" --train_type="causal_lm_loss" \
    ...
    --torch_dtype=bfloat16 --bf16=True --save_steps=10 \
    --label_names="labels" --num_train_epochs=2 \
